...
Partial Class Reset
    ...
    Private Sub InitializeComponent()
        ...
        Me.HuraForm1.Text = "Temp cleanup"
        '
        'RichTextBox1
        '
        ...
        Me.RichTextBox1.Text = "This will clean all the temp files that can be removed while computer is in full " & _
    "use." & Global.Microsoft.VisualBasic.ChrW(10) & "If this is run at boot then all temp files will be deleted"
        '
        'HuraButton3
        '
